...
public class BaseActivity extends AppCompatActivity {
    ...
    public static String BASE_URL = "http://192.168.1.51:8787/api/";
    public static String BASE_URL_PICTURE = "http://192.168.1.51:8787";
    ...
    public void dialogResultError() {
        new AlertDialog.Builder(this, R.style.AppTheme_Dark_Dialog)
                .setTitle("Alert")
                .setMessage("ไม่สามารถเข้าใช้งานได้ กรุณาลองใหม่ภายหลัง ")
